...
```bash
INIT=$(node "/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
