...
- **Global scope**: `/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/notes/`)
...
2. Glob `/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/notes/` — works in any directory
