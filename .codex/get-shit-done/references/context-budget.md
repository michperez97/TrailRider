...
The keys live in `.codex/settings.json` (project) or `/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/settings.json` (global) — **not** in `.planning/config.json`:
