...
Knowledge graph is disabled. To activate:
  ...
  node /Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/Users/michelperezmachado/Desktop/SE_And_Documents/Studies/Software_Engineering/Crocobyte/01_Active/Mountain_Bike_iOS/.codex/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
